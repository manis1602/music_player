...
class FavouriteFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        favouriteDatabase = EchoDatabase(activity as Activity)
        noFavourites = view?.findViewById<TextView>(R.id.noFavourites) as TextView
        nowPlayingBottomBar = view.findViewById<RelativeLayout>(R.id.hiddenBar) as RelativeLayout
        songTitle = view.findViewById<TextView>(R.id.songTitle) as TextView
        ...
        recyclerView = view.findViewById<RecyclerView>(R.id.favouriteRecycler) as RecyclerView
        return view
    }
    ...
    fun display_favorites_by_searching() {
        if (favouriteDatabase?.checkSize() as Int > 0) {
            ...
            val _mainScreenAdapter = FavouriteContentAdapter(activity as Context, refreshList as ArrayList<Songs>)
